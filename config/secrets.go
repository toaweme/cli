...
// named "secrets" under dir, where each secret is a key within it (read with KeyRead,
// written with KeyWrite). A leading "~" in dir expands to the user's home directory.
